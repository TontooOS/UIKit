//! ImageView widget — displays an image using GtkPicture.
//!
//! This is the UIKit equivalent of `UIImageView` in Apple's UIKit.
//!
//! ```rust,no_run
//! use uikit::prelude::*;
//!
//! let image = ImageView::new("/path/to/image.png")
//!     .size(128.0, 96.0)
//!     .opacity(0.8);
//!
//! let view = View::new(image)
//!     .with_frame(16.0, 16.0, 128.0, 96.0);
//! ```
...
impl ViewContent for ImageView {
    fn render(&self, frame: Rect) -> gtk::Widget {
        ...
        if frame.width > 0.0 {
            picture.set_width_request(frame.width as i32);
        }
        if frame.height > 0.0 {
            picture.set_height_request(frame.height as i32);
        }
...
mod tests {
    ...
    #[test]
    fn imageview_builder() {
        let img = ImageView::new("/icons/app.png").size(128.0, 96.0).opacity(0.8);
